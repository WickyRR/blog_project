        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Category List
                <a href="{{ url('panel/category/add') }}" class="btn btn-primary" style="float:right; margin-top:-10px; margin-left:-20px;">Add New</a>
            </h5>
                ...
                @forelse ($getRecord as $value)
                    <tr>
                        ...
                        <td>
                            ...
                            <a onclick = "return confirm('Are you want to delete record?')" href="{{ url('panel/category/delete/'.$value->id) }}" class="btn btn-danger btn-sm">Delete</a>
                        </td>
                    </tr>
