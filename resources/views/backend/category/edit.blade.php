        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="col-12">
                ...
                <input type="text" class="form-control" id="slug" name="slug" value="{{ $getRecord->slug }}" >
                <div style="color: red">{{ $errors->first('slug') }}</div>
            </div>
            <div class="col-12">
                <label for="inputTitle" class="form-label">Title</label>
                <input type="text" class="form-control" id="slug" name="title" value="{{ $getRecord->title }}" >
                <div style="color: red">{{ $errors->first('title') }}</div>
            </div>
            <div class="col-12">
                <label for="inputMetaTitle" class="form-label">Meta Title</label>
                <input type="text" class="form-control" id="slug" name="meta_title" value="{{ $getRecord->meta_title }}" >
                <div style="color: red">{{ $errors->first('meta_title') }}</div>
            </div>
            <div class="col-12">
                <label for="inputMetaDescription" class="form-label">Meta Description</label>
                <textarea class="form-control" id="slug" name="meta_description"  >{{ $getRecord->meta_description }}</textarea>
                <div style="color: red">{{ $errors->first('meta_description') }}</div>
            </div>
            <div class="col-12">
                <label for="inputMetaKeywords" class="form-label">Meta Keywords</label>
                <input type="text" class="form-control" id="slug" name="meta_keywords" value="{{ $getRecord->meta_keywords }}" >
